...
#from app.models import BlockedVisitor, todaysvisiter   # change app to your real app name


print("RUNNING OUTSIDE CAMERA.PY")
...
def start_live_monitoring():
    ...
    # Safer settings for your current face model
